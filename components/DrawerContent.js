        ...
        <View style ={{backgroundColor:colors.buttons,}}>
            <View  style={{flexDirection:'row', alignItems:'center',paddingLeft:20,paddingVertical:10}}>
                ...
                <View style ={{marginLeft:10}}>
                        <Text style ={{fontWeight:'bold',color:colors.cardbackground,fontSize:18 }} >Truong Pham</Text>
                        <Text style ={{color:colors.cardbackground,fontSize:14}} >Truong@DTFood.com</Text>
                </View>
